...
module.exports = DogeXeonOP = async(DogeXeonOP, mek, _welkom) => {
        try {
            ...
            const tanggal = moment.tz('Asia/Colombo').format('dddd') + ', ' + moment.tz('Asia/Colombo').format('LL')
            const time = moment().tz('Asia/Colombo').format("HH:mm:ss")
            const timeMak = moment().tz('Asia/Colombo').format("HH:mm:ss");
            const timeJay = moment().tz('Asia/Colombo').format("HH:mm:ss");
            ...
            const ownerNumber = [`${owner}@s.whatsapp.net`, `94767184785@s.whatsapp.net`]
...
╰───「👻 *ʟᴇᴠᴇʟ ᴜᴘ* 👻」`)
                        ...
                        sendButton(from, lvlup, ' *♢○○ᵀᵉᶜʰⁿʸ Qᵘᵉᵉⁿ○○♢* ', but)
...
*Story* : ${res.background_story}`
                ...
                case 'hartatahta':
                    ...
                    DogeXeonOP.sendMessage(from, harta, image, { quoted: mek, caption: '*ᵍᵉⁿᵉʳᵃᵗᵉᵈ ᵇʸ ᵗᵠ ᵇᵒᵗ* ✔️' })
                    break
                ...
                case 'girlneko':
                    ...
                    DogeXeonOP.sendMessage(from, girlneko, image, { caption: `*ᵍᵉⁿᵉʳᵃᵗᵉᵈ ᵇʸ ᵗᵠ ᵇᵒᵗ* ✔️`, quoted: mek })
                    break
                case 'sadboy':
                    ...
                    DogeXeonOP.sendMessage(from, girlneko2, image, { caption: `*ᵍᵉⁿᵉʳᵃᵗᵉᵈ ᵇʸ ᵗᵠ ᵇᵒᵗ* ✔️`, quoted: mek })
                    break
                case 'makerkaneki':
                    ...
                    DogeXeonOP.sendMessage(from, girlneko8383, image, { caption: `*ᵍᵉⁿᵉʳᵃᵗᵉᵈ ᵇʸ ᵗᵠ ᵇᵒᵗ* ✔️`, quoted: mek })
                    break
                case 'rem':
                    ...
                    DogeXeonOP.sendMessage(from, girlneko11111, image, { caption: `*ᵍᵉⁿᵉʳᵃᵗᵉᵈ ᵇʸ ᵗᵠ ᵇᵒᵗ* ✔️`, quoted: mek })
                    break
                case 'lolimaker':
                    ...
                    DogeXeonOP.sendMessage(from, girlnekojkjk, image, { caption: `*ᵍᵉⁿᵉʳᵃᵗᵉᵈ ᵇʸ ᵗᵠ ᵇᵒᵗ* ✔️`, quoted: mek })
                    break
                case 'gura':
                    ...
                    DogeXeonOP.sendMessage(from, girlnekoooo, image, { caption: `*ᵍᵉⁿᵉʳᵃᵗᵉᵈ ᵇʸ ᵗᵠ ᵇᵒᵗ* ✔️`, quoted: mek })
                    break
                case 'wolf3':
                ...
                case 'sourcode':
                    ...
                    scsell = `*Techny Queen Bot V2 Script* \n\n• GitHub: https://github.com/ChamiyaX \n• website: https://chamiyapage.netlify.app/ \n\n_𝙄𝙛 𝙮𝙤𝙪 𝙬𝙞𝙨𝙝 𝙩𝙤 𝙗𝙪𝙮 𝙪𝙣𝙚𝙣𝙘𝙧𝙮𝙥𝙩𝙚𝙙 𝙨𝙘𝙧𝙞𝙥𝙩 𝙘𝙡𝙞𝙘𝙠 𝙤𝙣 𝙩𝙝𝙚 𝙗𝙪𝙮 𝙨𝙘𝙧𝙞𝙥𝙩 𝙗𝙪𝙩𝙩𝙤𝙣 𝙗𝙚𝙡𝙤𝙬._`
                    but = [
...
*Description* : ${i.snippet}`
                ...
                case 'googleimg':
                    ...
                    function google(error, result) {
                        if (error) { return reply('_[ ! ] Api Error Or Result Not Found_') } else {
                            var gugIm = result
                ...
                case 'clearall':
                    ...
                    textImg(' Deleted All Chat Successfully✔️')
                    break
                case 'setbotpp':
                case 'setppbot':
                    if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner)
                ...
                case 'nsfw':
                    ...
                    if ((args[0]) === 'on') {
                        if (isNsfw) return reply('*nsfw is active * ✔️')
                        _nsfw.push(from)
                ...
                case 'welcome':
                    ...
                    if ((args[0]) === 'on') {
                        if (isWelkom) return reply('*welcome is active * ✔️')
                        _welkom.push(from)
                ...
                case 'gcinfo':
                    ...
                    let ingfo = `*G R O U P I N F O*\n\n*Name :* ${groupName}\n*Group ID :* ${from}\n*Made :* ${moment(`${groupMetadata.creation}` * 1000).tz('Asia/Colombo').format('DD/MM/YYYY HH:mm:ss')}\n*Group Owner :* @${groupMetadata.owner.split('@')[0]}\n*Number of Admins :* ${groupAdmins.length}\n*Number of participants :* ${groupMembers.length}\n*Welcome :* ${isWelkom ? 'Aktif' : 'Mati'}\n*AntiLink :* ${isAntiLink ? 'Aktif' : 'Mati'}\n*Desc :* \n\n${groupMetadata.desc}`
...
reply(`${err}`)
	...
	DogeXeonOP.sendMessage(`${owner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "චමියගේ වැඩක් තමා😊",body:"Dont forget Thanks",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/dogepic1.jpg'),sourceUrl:"https://wa.me/94767184785"}}})
        }
	// console.log(e)
	}
}